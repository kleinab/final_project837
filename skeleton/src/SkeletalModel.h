...
private:
	...
	void drawJointsRecursion(Joint * parentJoint);
	void drawSkeletonRecursion(Joint * parentJoint);
	void computeBindWorldToJointTransformsRecursion(Joint * parentJoint);
	void updateCurrentJointToWorldTransformsRecursion(Joint * parentJoint);
};
